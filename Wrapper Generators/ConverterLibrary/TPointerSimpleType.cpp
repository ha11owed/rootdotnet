...
namespace {
  ...
  string net_type (const string simple_type, bool is_const)
  {
    string result("");
...
///
TPointerSimpleType::TPointerSimpleType(const std::string &base_type, bool is_const)
    : TypeTranslator (net_type(base_type,is_const), base_type + "*"), _is_const(is_const), _base_type(base_type)
  {
  }
